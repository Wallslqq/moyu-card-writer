...
<focused_target id="char-1" area="" />

必须结合当前域、作品现状和作者本轮输入判断真正目标。

</current_workshop_page>

<current_creation_environment domain="人物" area="" task="airp_basic_information">
...
<character_workspace focused_id="char-1" focused_area="">
...
<image index="1" name="cover.fixture.png" media_type="image/png" path="验收/cover.fixture.png">
