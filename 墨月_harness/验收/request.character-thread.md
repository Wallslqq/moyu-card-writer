<!-- route: domain=character task=airp_character_nature permission=answer artifactIntent=false batch=none -->
...
<focused_target id="char-1" area="characterNature" />

必须结合当前域、作品现状和作者本轮输入判断真正目标。

</current_workshop_page>

<current_creation_environment domain="人物" area="characterNature" task="airp_character_nature">
...
<knowledge id="airp_character_nature">
...
<character_workspace focused_id="char-1" focused_area="characterNature">
...
<message_text>
<![CDATA[她的内核是想要被看见，不是缺爱。]]>
</message_text>

## 2. assistant

记下了：内核是「想要被看见」，指向被承认而不是被填补。
